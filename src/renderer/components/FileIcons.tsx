...
export function getFileIcon(filename: string, isDir: boolean, expanded?: boolean): { color: string; svg: React.JSX.Element } {
  if (isDir) {
    if (expanded) {
      return {
        color: '#dcb67a',
...
function makeFileIcon(color: string, label?: string): { color: string; svg: React.JSX.Element } {
  return {
    color,
    svg: (
